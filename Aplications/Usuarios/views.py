...
def home(request):
    ...
    if request.method == 'POST':
        ...
        return render(request,'Main.html',{'product':products,'categorias':categoria},id)
    else:
         
        return render(request,'Main.html',{'product':products,'categorias':categoria})
    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            ...
            try:
                ...
                return render(request,'Registros/base-signup.html',{'form':tabla,'error':error})
...
def init(request):
    if request.method == 'GET':
        ...
        return render(request,'Registros/base-signup.html',{'form':aut})
         ...
         if user is None:
             aut = Authformi
             return render(request,'Registros/base-signup.html',{'form':aut,'error': 'NO SE ENCUANTRA EL USUARIO '})
         else:
           login(request,user)
